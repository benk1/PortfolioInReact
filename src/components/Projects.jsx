              ...
              >
                ...
                <div>
                  ...
                  <p>
                    ...
                    and deleting presenters from the database and navigate through different pages
                    using react-router.
                  </p>
                </div>
              </a>
            ...
            <h5>
              ...
              >
                ...
                <div>
                  ...
                  <p>WorldCountries</p>
                  <p>
                    This is an App created using ReactJs ,you can visualize Countries around the globe and view specific details about a specific
                    country including their capital city, population of each country, name of a certain country plus
                    their specific flag attached to each country. you can search each country by Country's name and
          ...
          <div className="project-4">
            <h5>
              ...
              >
                ...
                <p>Movie Rental App<br></br>
                  This is a MERN fUll-stack MovieRental Application, a user can View movies only,
                  signed in users can add and edit movies,while admin can delete a movie.
                  It is built using MongoDb,Express,React and NodeJs.
                </p>
          ...
          <div className="project-2">
            <h5>
              ...
              >
                ...
                <p>Counter-App</p>
                <p>
                  A Simple application but powerful application, its purpose is to  teach how
                  reacts work in all aspects.it is based on counter where you
                  can increase or decrease counter while other functionalities
                  are taking place in the process.
                </p>
              </a>
            </h5>
          </div>
          ...
          <div className="project-5">
            <h5>
              ...
              >
                ...
                <p>Reactjs App </p>
                <p>CAT API<br></br>
                  This is an Application where you can fetch data from an API about your favourite cat,
                  You can view and search where the cat is from originally and see all the important feature about
                  that cat. Upon clicking the Name of the cat you view more details about the cat.
                </p>
          ...
          <div className="project-9">
            <h5>
              ...
              >
                ...
                <p> ArrayOfCountriesInReact<br></br>
