      ...
      <div className='kilimanjaro'>
        <div className='text'>
          <p>
            ...
            Technologies, since my graduation at Metropolia University of applied science
            in Finland-Helsinki, I have been lucky enough to be involved in multiple IT projects,
            but this time, I am in a phase of my career where I want to be very
            close to the user and this is to why i pursue this phase of
            front-end development,apart from that i have been involved in back-end development
            as well.Beyond the web-development I am currently
