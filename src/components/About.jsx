		...
		<div>
			...
			<div className="about">
				<p>
					...
					on Rails, which has really sparked me into web development. I had a
					great time working on different software development methodologies
					including functional and unit testing on the process. I was lucky
					enough to work with another company called Integrify Oy located in the
					heart of Helsinki capital city Of Finland, where I built most of my
					projects and stabilize myself as a full web-developer, for more about
					what projects I have been building,please click the links below and
					check it out{' '}
				...
				<p>
					...
					more working with HTML5, CSS, JAVASCRIPT, ReactJS/Redux,NodeJs,Express
					and many more web-technologies. I have good knowledge of using
					GIT(version control system),Mysql,MongoDB databases, good with Regular
